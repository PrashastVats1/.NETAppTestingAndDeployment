...
namespace BookStoreApp.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(BookStoreDb0105Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'BookStoreDb0105Context.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoreDb0105Context.Publishers'  is null.");
            }
            var publisher = await _context.Publishers.FindAsync(id);
            if (publisher != null)
            {
